...
FixtureManifest → Runner → SystemAdapter → Assertions/Scorers →
ResultBundle → comparative report.

Suites include provenance, locator round-trip, source independence, contradiction,
negative evidence, authorization, prompt injection, orchestration, citation/quote reliability.

## Extension points

System adapters, fixture generators, scorers, benchmark datasets, report exporters.
